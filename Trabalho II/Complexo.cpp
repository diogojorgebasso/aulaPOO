...
double Complexo::getReal() const { return real; }

double Complexo::getImag() const { return imaginario; }

void Complexo::setReal(double r) { real = r; }

void Complexo::setImag(double i) { imaginario = i; }
...
void Complexo::imprimir() { cout << real << " + " << imaginario << "i"; }
