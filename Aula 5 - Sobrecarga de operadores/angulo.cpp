...
Angulo::Angulo(double g) { grau = fmod(g, 360); }

double Angulo::radiano() { return grau * PI / 180; }

double Angulo::seno() { return sin(radiano()); }

double Angulo::cosseno() { return cos(radiano()); }

double Angulo::tangente() { return tan(radiano()); }
...
// conversao de tipo
Angulo::operator double() const { return grau; }
