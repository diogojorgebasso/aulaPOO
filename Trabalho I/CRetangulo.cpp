...
// Get
int CRetangulo::get_comprimento() { return comprimento; }

int CRetangulo::get_altura() { return altura; }
...
bool CRetangulo::isQuadrado() { return comprimento == altura; }

// Set
void CRetangulo::set_comprimento(int c) { comprimento = validar_valor(c); }

void CRetangulo::set_altura(int a) { altura = validar_valor(a); }
...
// Math
int CRetangulo::area() { return comprimento * altura; }

int CRetangulo::perimetro() { return 2 * (comprimento + altura); }
...
int main() {
  ...
  r1.imprime();
  cout << "Área = " << r1.area() << ", perímetro = " << r1.perimetro() << endl;
  r2.imprime();
  cout << "Área = " << r2.area() << ", perímetro = " << r2.perimetro() << endl;
